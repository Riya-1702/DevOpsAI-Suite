...
def run_app():
    ...
    try:
        ...
        st.markdown("Tell me how you're feeling, and I'll find a playlist to match your mood.")
        st.markdown("---")
        
        # Add debug information
        st.sidebar.info("Debug: run_app function started successfully")
    except Exception as e:
        st.error(f"Error in initializing UI: {str(e)}")
        return
    ...
    try:
        ...
        # Add debug information
        st.sidebar.success("Debug: API key loaded successfully")
    except Exception as e:
    ...
    try:
        ...
        # Add debug information
        st.sidebar.success("Debug: LLM initialized successfully")

        # Define the list of tools the agent can use
        tools = [get_emotion_from_text, get_song_link_by_mood]

        # Create the LangChain agent executor
        agent_executor = create_react_agent(llm, tools)
        
        # Add debug information
        st.sidebar.success("Debug: Agent initialized successfully")
    except Exception as e:
        st.error(f"Error initializing LLM or Agent: {str(e)}")
        st.stop()
    ...
    try:
        if "messages" not in st.session_state:
            ...
            # Add debug information
            st.sidebar.success("Debug: Chat session initialized")
        ...
        # Add debug information
        st.sidebar.success("Debug: Chat history displayed successfully")
    except Exception as e:
        st.error(f"Error setting up chat interface: {str(e)}")
        # Continue execution even if there's an error with the chat history
